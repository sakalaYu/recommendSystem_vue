      ...
      <div class="gray-box">
        ...
        <div class="js-list-inner">
          <div class="box-inner order-cart order-list-cart clear" v-for="(orderGroup, index) in groupedOrderData"
            ...
            <div class="cart" v-for="(item, index) in orderGroup.items" :key="index">
              <div class="cart-items clear">
                <div class="prod-info clear">
                  ...
                  <div class="check">
                    <p @click="check(item.id)">查看详情&gt;</p>
                    <!-- <router-link :to="{ name: 'Detail', query: { orderId: item.id } }">查看详情&gt;</router-link> -->
                  </div>
                  <!-- <div class="total">{{ item.subject }}</div> -->
                  <!-- <el-button class="button_check" icon="el-icon-search" circle></el-button>
              <el-button type="danger" icon="el-icon-delete" circle class="delete"></el-button> -->
                </div>
              </div>
            </div>
          </div>
